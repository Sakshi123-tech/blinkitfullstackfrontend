        ...
        <div className='bg-blue-50 p-2 grid gap-4'>
              {
                addressList.map((address,index)=>{
                  return(
                       <div key={index} className={`border rounded p-3 flex gap-3 bg-white ${address.status === false && 'hidden'}`} >
                          ...
                          <div className=' grid gap-10'>
                            <button onClick={()=>{
                              setOpenEdit(true)
                              setEditData(address)
                            }} className='bg-green-200 p-1 rounded h-10 text-center hover:text-white hover:bg-green-600'>
                              <MdEdit/>
                            </button>
                            {/* <button onClick={()=>
